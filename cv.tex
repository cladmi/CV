...
2011~--~2013            & \activite{Support, architecture et développement de plateforme de réseau de capteur}\\
...
\activite{Langages~:}   & \comment{Maîtrisés~:\,C, Python, Assembleur(x86, RISC, DSP), Bash}\\
                ...
                %        \comment{C, Assembleur(x86, RISC, , BashAssembleur, Bash, C, C++, Objective-C~-~iOS, Java, \LaTeX, SQL, {SystemC~-~TLM}, VHDL}\\
                        ...
                        \activite{Outils~:} &
                        \comment{Environnement GNU/Linux, Terminal, vim, Git/Mercurial/SVN, Debugger, Jenkins}
\end{rubriquetableau}

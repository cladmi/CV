...
2011~--~2015            & \activite{Architecture, développement sur plateforme de réseau de capteur FIT-IoT-LAB}\\
\group{1$^{er}$ emploi}
	                & \hs Conception et développement de l'architecture logicielle, système et réseau de la plateforme.\\
~			& \hs Génération de distribution embarqué Linux Yocto, et déploiement large échelle NFS.\\
~		        & \hs Développement embarqué d'application d'administration, librairies et exemples utilisateur.\\
~		        & \hs Outils utilisateurs d'accès et d'automatisation d'expérimentation.\\
~		        & \hs Mise en place et application d'une démarche d'intégration continue.\\
~		        & \hs Documentation et support utilisateur développement embarqué et utilisation plateforme\\
...
2011			& \activite{Stage Fin d'étude - Sauvegarde externe de contexte pour récepteur satellite}\\
			...
			\texttt{Architecture mémoire, Assembleur, C++, gdb, ldscript}.
...
\activite{Distribué}    & Table de hachage distribuée - \textsl{C, socket} \\
...
\activite{Outils~:}     & \comment{GNU/Linux, Git, Yocto, Jenkins, Terminal/vim}\\
\activite{Tests~:}      & \comment{Tests unitaires et d'intégration, mise en place d'une démarche d'intégration continue}
\end{rubriquetableau}
...
\begin{rubriquetableau}[2.5cm]{Loisirs}
                        & Musique métal, Jeux vidéos, Escalade\\

...
2005~--~2006 		& \activite{Construction de la maison familiale}{Maçonnerie, charpente, couverture, parquet}\\

2005~--~2006 		& \projet{Emploi d'été}{Entretient de cimetière militaire}\\
...
\begin{rubriquetableau}[2.5cm]{Compétences en informatique}
			...
			\comment{Environnement de développement Linux, Debugger, Git/Mercurial/SVN, Terminal, Vim, Xcode}
\end{rubriquetableau}

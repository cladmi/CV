...
~                       & \hs Génération de distribution embarquée Linux Yocto, et déploiement large échelle NFS.\\
...
\activite{Outils~:}     & \comment{GNU/Linux, Git avancé, Yocto, Jenkins, Terminal/vim}\\

...
2011~--~2012		& \projet{Premier emploi~:\,}{Support utilisateur de plateforme de réseau de capteur}\\
~			& \comment{\hs Développement et support utilisateur sur systêmes d'exploitations
			embarqués orientés réseau. Développement embarqué, tutoriaux, support, évolution plateforme.}\\
~			& \lieu{\hs Équipe FIT-SensLAB - Inria Grenoble}\\
...
\activite{Langages~:}	& \comment{Maîtrisés~:\,C, Assembleur(x86, RISC, DSP), Bash}\\
			& \comment{Notions~:\,C++, Objective-C~-~iOS, Java, \LaTeX, Ruby, SQL, {SystemC~-~TLM}, VHDL}\\

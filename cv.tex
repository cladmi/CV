...
\begin{rubriquetableau}[2.5cm]{Compétences en informatique}% TODO
			...
			\comment{Assembleur, Bash, C, C++, Objective-C~-~iOS, Java, \LaTeX, SQL, {SystemC~-~TLM}, VHDL}\\ % TODO

			& \activite{Outils maîtrisés~:}
			\comment{Cygwin, Environnement de développement Linux, Debugger, Git/Mercurial/SVN, Vim, Xcode}
			% script shell
			% Environnement unix
\end{rubriquetableau}
